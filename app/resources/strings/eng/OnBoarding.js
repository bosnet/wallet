const OnBoarding = {
  SplashScreen: {
    ALERT_UPDATE_TITLE: 'Update',
    ALERT_FORCE_UPDATE_MESSAGE: 'Please update application for more stable service provide.',
    ALERT_UPDATE_MESSGAE: 'Please update latest application & Meet newer BOScoin wallet.',
    ALERT_GENERAL_TITLE: 'Alert',
    ...
    ALERT_NO_RESPONSE: 'Server is not responding.',
