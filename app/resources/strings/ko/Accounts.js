const Accounts = {
  Precaution: {
    TITLE: '계좌 생성 주의사항',
    PRECAUTION_1: '유효한 계좌를 만들기 위해서는 최소 잔액이 필요합니다.\n비밀번호 설정 후 최소 잔액 0.1BOS를 보내세요',
    PRECAUTION_2: '계좌 이름 및 주소록의 정보는 앱에 저장되는정보로서 앱을 삭제하거나 기기를 변경하면 모든 정보가 사라집니다. 중요한 공개\n주소는 따로 보관하세요',
    PRECAUTION_3: '비밀번호는 송금, 보안키 조회, 계좌 가져오기를 할 때 필요합니다. 비밀번호는 잃어버리면찾을 수 없으니 반드시 기억하세요',
    PRECAUTION_4: '보안키와 복구키는 계좌 가져오기 할 때 필요합니다.잃어버리거나 타인에게 공유하지 마세요',
  ...
  SetPassword: {
    ...
    WARNING1: '* 비밀번호를 변경하게 되면, 기존의 복구키는 사용하실 수 없습니다',
    WARNING2: '* 비밀번호 변경 완료 후 새로운 복구키를 안전한 곳에 저장해 주시기 바랍니다',
  ...
  ImportAccount: {
    ...
    TOAST_RK_NOT_VALID: '보안키가 올바르지 않습니다',
    ...
    NOTICE2: '* 이 계좌의 비밀번호를 모를 경우 복구키로 계좌를 가져올 수 없으오니,\n보안키를 이용하여 계좌 가져오기를 시도해 주시기 바랍니다',
    NOTICE2_SS: '* 보안키를 잊어버린 경우 보안키로 계좌를 가져올 수 없으오니,\n복구키로 계좌 가져오기를 이용해 주시기 바랍니다',
  ...
  AccountCreated: {
    ...
    TOAST_CLIPBOARD_SS: '보안키가 클립보드에 복사되었습니다',
    TOAST_CLIPBOARD_RK: '복구키가 클립보드에 복사되었습니다',

    SS_TITLE: '보안키 백업',
    RK_TITLE: '복구키 백업',

    RK_HEADTEXT: '안전한 곳에 복구키를 보관해주세요\n복구키는 비밀번호와 함께 보관해 주세요',
    SS_HEADTEXT: '안전한 곳에 보안키를 보관해주세요',
  },
  SelectImportType: {
    TITLE: '가져오기 방법 선택',
    BACK_BUTTON: '닫기',
  ...
  WarningKeyLeakageRestore: {
    ...
    TITLE_SS: '보안키 유출 주의',
    TITLE_RK: '복구키 유출 주의',
    MESSAGE_SS: '보안키를 잃어버리거나 타인에게 노출이 될 경우\n이 계좌에 있는 모든 코인을 도난 당하게 됩니다\n보안키 보안에 각별히 신경써 주시기 바랍니다',
    MESSAGE_RK: '복구키와 비밀번호를 잊어버리거나 타인에게\n누출이 될 경우 이 계좌에 있는 모든 코인을\n도난 당하게 됩니다\n복구키 보안에 각별히 신경써 주시기 바랍니다',
  ...
  ConfirmBackUp: {
    ...
    NOTI: '* 보안키, 복구키, 비밀번호를 안전한 곳에 보관하지 않은 상태에서\n계좌를 삭제할 경우 계좌 내 모든 보스코인을 통제할 수 없게 됩니다!',
