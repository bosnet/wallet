const Accounts = {
  Precaution: {
    TITLE: '계좌 생성 주의사항',
    PRECAUTION_1: '유효한 계좌를 만들기 위해서는 최소 잔액이 필요합니다. 비밀번호 설정 후 최소 잔액 0.1 BOS를 보내세요.',
    PRECAUTION_2: '계좌 이름 및 주소록의 정보는 앱에 저장되는 정보로서 앱을 삭제하거나 기기를 변경하면 모든 정보가 사라집니다. 중요한 공개 주소는 따로 보관하세요.',
    PRECAUTION_3: '비밀번호는 송금, 보안키 조회, 계좌 가져오기를 할 때 필요합니다. 비밀번호는 잃어버리면 찾을 수 없으니 반드시 기억하세요.',
  ...
  ChangeAccountName: {
    ...
    NOTICE: '지금 등록한 이름은 BOScoin Wallet을 삭제하거나, 계좌 가져오기를 통해 앱을 이전할 경우 모두 사라집니다.',
  ...
  WarningKeyLeakageRestore: {
    ...
    TITLE_SS: '보안키 유출 주의',
    TITLE_RK: '복구키 유출 주의',
    MESSAGE_SS: '보안키를 잃어버리거나 타인에게 노출이 될 경우, 이 계좌에 있는 모든 코인을 도난 당하게 됩니다. 보안키 보안에 특별히 신경써 주시기 바랍니다.',
    MESSAGE_RK: '복구키와 비밀번호를 잊어버리거나 타인에게 누출이 될 경우, 이 계좌에 있는 모든 코인을 도난 당하게 됩니다. 복구키 보안에 특별히 신경써 주시기 바랍니다.',
    NOTI_SS: '보안키는 계좌를 가져올 때 사용됩니다.',
    NOTI_SS2: '보안키, 복구키, 비밀번호는 본인 외에는 아무도 알 수 없으니, 반드시 잘 보관해 주시기 바랍니다.',
    NOTI_RK: '복구키와 비밀번호는 계좌를 가져올 때 사용됩니다.',
    NOTI_RK2: '보안키, 복구키, 비밀번호는 본인 외에는 아무도 알 수 없으니, 반드시 잘 보관해 주시기 바랍니다.',
  ...
  ConfirmBackUp: {
    ...
    MESSAGE: '보안키, 복구키, 비밀번호를 모두 안전한 곳에 보관하셨나요?',
