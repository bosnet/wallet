const Settings = {
  ...
  Warning: {
    ...
    CONTEXT1: '보안키, 복구키, 비밀번호를 잃어버리거나 타인에게 공유하면, 당신의 귀한 자산을 모두 잃어버릴 수 있어요.',

    HEAD_TEXT2: '항상 주변을\n잘 살피기',
    CONTEXT2: 'Wallet을 사용 중에 누군가 몰래 엿보지 않는지 항상 주의를 기울여 주세요. 사용 후 반드시 앱을 종료해 주세요.',
  ...
  AddressBook: {
    ...
    NOTI: 'BOScoin Wallet을 삭제하면 주소록에 저장된 정보는 모두 사라지며 복구할 수 없습니다.\n중요한 주소는 따로 안전한 곳에 보관해 주시기 바랍니다.',
