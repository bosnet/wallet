...
export const MAINNET_ADDR = 'https://mainnet.blockchainos.org';
...
export const NETWORK_ID = 'sebak-test-network';
export const MAINNET_NETWORK_ID = 'sebak-network; 2018-11-26';
export const BOS_GON_RATE = 10000000;
